...
We calculated average precision at ten documents seen (P@10). In
the first patient case six out of ten retrieved documents were automatically
deemed relevant, giving a precision of \( 60\% \).
\autoref{tab:precision} list P@10 for all eight patient cases.
\begin{table}[htbp] \footnotesize \center
