...
preprocessing and parsing of input files. The first two tasks uses a probablistic method to find the most relevant results.

In task 3 a better, but more complex solution, is applied; the use of vector models to determine the proximity in addition to the probablistic models. 
TODO: write some sentences about all tasks
...
% ha med?
% A therapy chapter can be a chapter, a sub or subsub chapter. 
