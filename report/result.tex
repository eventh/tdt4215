...
Results for task 1 B (therapy chapter T1.1.1, ) can be seen in
\autoref{tab:task1b}, which list relevant ATC codes for each sentence.
\begin{table}[htbp] \footnotesize \center
\caption{Task 1 B, therapy chapter T1.1.1, \label{tab:task1b}}
\begin{tabular}{c c l l}
    \toprule
